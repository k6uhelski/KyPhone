...
- 160 new tests (413 in all); checked against real Project Gutenberg books (Alice in Wonderland, The Count of Monte Cristo).
...
- There are now 413 tests, including pixel checks on the emulator and a host-side build of the firmware renderers under sanitizers.
