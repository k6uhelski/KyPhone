...
**Current version: 0.6.6** (defined once, in `spi_bridge/version.py`; the lock screen shows it as "OS 0.6.6"). **Design library: 0.2.1** — the reader and music screens are newer than it and are not in it yet.
