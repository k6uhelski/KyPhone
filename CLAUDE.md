...
| settings | four rows: Wi-Fi and Bluetooth (each with its status; Enter opens that list), **Screen light** (Level n of 8 / Off; Enter opens SCREEN LIGHT) and **Activity mark** (ON/OFF; Enter switches it). ↑↓; ↑ past the first → header (Enter → home); Esc → home. Saved in `data/settings.json` |
...
### **Tests and tools**
Thirteen suites, 815 tests (`test_state_machine.py` 335, `test_reader_state.py` 47, `test_reader_epub.py` 47, `test_reader_fonts.py` 11, `test_reader_layout.py` 31, `test_music_library.py` 53, `test_music_player.py` 43, `test_music_state.py` 41, `test_simulator.py` 84, `test_firmware_host.py` 58, `test_version.py` 8, `test_network_control.py` 39, `test_modem.py` 18):
