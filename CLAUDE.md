...
| settings | two rows, Wi-Fi and Bluetooth, each with its status. ↑↓; ↑ past the first → header (Enter → home); Enter opens that network list; Esc → home |
