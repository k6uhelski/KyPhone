...
### **Tests and tools**
Ten suites, 586 tests (`test_state_machine.py` 203, `test_reader_state.py` 44, `test_reader_epub.py` 47, `test_reader_fonts.py` 11, `test_reader_layout.py` 31, `test_music_library.py` 53, `test_music_player.py` 43, `test_music_state.py` 41, `test_simulator.py` 66, `test_firmware_host.py` 47):
